...
import { getMovies } from "../../redux/actions/movies.js";
    ...
    <div>
      <div className="container-fluid bg-dark mb-5">
        <div className="row p-5" style={{}}>
          ...
          <h3 className="text-warning mb-5">Your chosen language is <span className="text-light"> {lang === "en"? "English" : "Arabic"} </span>  </h3>
          < div className="col-4">
      <button
      ...
      </button></div>  < div className="col-8"></div>
